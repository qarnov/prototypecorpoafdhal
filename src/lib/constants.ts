...
export const DUMMY_POSTS: Post[] = [
  { id: '1', userId: 'u1', username: 'arjun_k', userRank: 'Gold', text: 'Ran out of fuel near Whitefield signal. Petrol pumps closed. Any biker nearby who can help? Happy to pay', category: 'urgent', areaName: 'Whitefield', distance: '0.4km', timestamp: '2 mins ago', status: 'open' },
  { id: '2', userId: 'u2', username: 'priya_m', userRank: 'Solver', text: 'Looking to carpool to Koramangala around 9AM. Uber keeps cancelling. Anyone going that way?', category: 'carpool', areaName: 'HSR Layout', distance: '0.8km', timestamp: '5 mins ago', status: 'open' },
  { id: '3', userId: 'u3', username: 'dev_shah', userRank: 'Diamond', text: 'Need someone to print 2 pages urgently. Printer dead. Will Swiggy someone coffee in return', category: 'errand', areaName: 'Indiranagar', distance: '1.2km', timestamp: '12 mins ago', status: 'open' },
  { id: '4', userId: 'u4', username: 'sneha_r', userRank: 'Gold', text: 'My dog slipped out of the gate, anyone seen a black lab near Indiranagar?', category: 'emergency', areaName: 'Indiranagar', distance: '0.6km', timestamp: 'just now', status: 'open' },
  ...
  { id: '6', userId: 'u6', username: 'ananya_j', userRank: 'Vanguard', text: 'Tyre puncture near HSR Layout. Anyone with a pump or knows a nearby mechanic?', category: 'urgent', areaName: 'HSR Layout', distance: '1.8km', timestamp: '8 mins ago', status: 'open' },
];
